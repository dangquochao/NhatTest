window.__require = function e(t, n, r) {
  ...
  CaiDat: [ function(require, module, exports) {
    ...
    var CaiDat = function(_super) {
      ...
      CaiDat.prototype.start = function() {
        ...
        this.lbUserID.string = Windown_1.Windown.User.userId + "";
        this.lbUsername.string = Windown_1.Windown.User.nickName;
        this.lbUserdiamond.string = Windown_1.Windown.User.currentVipPoint + "";
      };
      ...
      CaiDat.prototype.onClickQuit = function() {
        cc.game.end();
      };
      ...
      __decorate([ property(cc.Label) ], CaiDat.prototype, "lbUserID", void 0);
      __decorate([ property(cc.Label) ], CaiDat.prototype, "lbUsername", void 0);
      __decorate([ property(cc.Label) ], CaiDat.prototype, "lbUserdiamond", void 0);
  ...
  ItemHomThu: [ function(require, module, exports) {
    ...
    var ItemHomThu = function(_super) {
      ...
      ItemHomThu.prototype.initItem = function(SFSObject) {
        ...
        this.getComponentInChildren(cc.Sprite).enabled = index % 2 == 0;
  ...
  ItemNhiemVu: [ function(require, module, exports) {
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.initItem = function(info) {
        ...
        var nameTab = info.getUtfString("nameTab");
        cc.log("NameTab=" + nameTab);
        ...
        switch (nameTab) {
         case "napngay":
          this.node.children[0].getComponent(cc.Sprite).spriteFrame = this.imgBg[0];
          break;

         case "choigame":
          this.node.children[0].getComponent(cc.Sprite).spriteFrame = this.imgBg[1];
          break;

         case "tanthu":
          this.node.children[0].getComponent(cc.Sprite).spriteFrame = this.imgBg[2];
        }
        this.getImg(typeImg);
      ...
      __decorate([ property(cc.Sprite) ], NewClass.prototype, "img", void 0);
      __decorate([ property([ cc.SpriteFrame ]) ], NewClass.prototype, "imgBg", void 0);
      __decorate([ property(cc.Label) ], NewClass.prototype, "lbName", void 0);
  ...
  ItemSuKien: [ function(require, module, exports) {
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.onClick = function() {
        ...
        this.bg.spriteFrame = this.spriteBg[1];
        this.lbInfo.node.color = new cc.Color().fromHEX("#350000");
      };
      __decorate([ property(cc.Label) ], NewClass.prototype, "lbStt", void 0);
      __decorate([ property(cc.Label) ], NewClass.prototype, "lbInfo", void 0);
      __decorate([ property([ cc.SpriteFrame ]) ], NewClass.prototype, "spriteBg", void 0);
  ...
  MainView: [ function(require, module, exports) {
    ...
    var MainView = function(_super) {
      ...
      MainView.prototype.hideNodeLogin = function() {
        ...
        var container = this.nodeLogin.getChildByName("Container");
        cc.Tween.stopAllByTarget(container);
        cc.log("winsize width:" + -cc.winSize.width / 2);
        cc.tween(container).to(.3, {
          ...
          cc.log("Show nodeLogin Done:" + container.x);
        }).start();
      };
      ...
      MainView.prototype.onClickJoinBaccarat = function(event, data, isForcePlay) {
        return __awaiter(this, void 0, void 0, function() {
          var funNex, isReturn, a, abc;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              funNex = null;
              isForcePlay && (funNex = function() {
                Windown_1.Windown.MainView.onClickJoinBaccarat(null, null, null);
              });
              isReturn = Windown_1.Windown.UIManager.onClickOpenBigGame(GAME_TYPE_1.default.Baccarat, funNex);
              if (!!isReturn) return [ 3, 3 ];
              Windown_1.Windown.UIManager.showLoading();
             ...
             case 1:
              _a.sent();
              return [ 4, Promise.resolve().then(function() {
                return require("../Bundle/Baccarat/Scripts/BaccaratController");
              }) ];
      ...
      MainView.prototype.onClickJoinKingKong = function(event, data, isForcePlay) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              funNex = null;
              isForcePlay && (funNex = function() {
                Windown_1.Windown.MainView.onClickJoinKingKong(null, null, null);
              });
              isReturn = Windown_1.Windown.UIManager.onClickOpenBigGame(GAME_TYPE_1.default.KingKong, funNex);
              if (!!isReturn) return [ 3, 2 ];
              Windown_1.Windown.UIManager.showLoadingData();
              return [ 4, Windown_1.Windown.loadBundle(GAME_TYPE_1.default.KingKong.toString()) ];

             case 1:
              bundle_2 = _a.sent();
              bundle_2.preloadScene("KingKong", {}, function(count, total) {
                Windown_1.Windown.UIManager.setPerData(count / total);
              }, function(err) {
                if (err) {
                  Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                ...
                bundle_2.loadScene("KingKong", function(err, scence) {
                  if (err) {
                    Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                    Windown_1.Windown.UIManager.hideLoadingData();
                    return;
                  }
                  cc.log("RunScene:" + scence.name);
                  cc.director.runScene(scence, null, function() {
                    cc.log("scene Run");
                  });
                });
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              bundle_3 = _a.sent();
              bundle_3.preloadScene("DieuThuyen", {}, function(count, total) {
                Windown_1.Windown.UIManager.setPerData(count / total);
              }, function(err) {
                if (err) {
                  Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                ...
                bundle_3.loadScene("DieuThuyen", function(err, scence) {
                  if (err) {
                    Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                    Windown_1.Windown.UIManager.hideLoadingData();
                    return;
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              bundle_4 = _a.sent();
              bundle_4.preloadScene("NgoKhong", {}, function(count, total) {
                Windown_1.Windown.UIManager.setPerData(count / total);
              }, function(err) {
                if (err) {
                  Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                ...
                bundle_4.loadScene("NgoKhong", function(err, scence) {
                  if (err) {
                    Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                    Windown_1.Windown.UIManager.hideLoadingData();
                    return;
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              bundle_5 = _a.sent();
              bundle_5.preloadScene("Neko", {}, function(count, total) {
                Windown_1.Windown.UIManager.setPerData(count / total);
              }, function(err) {
                if (err) {
                  Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                ...
                bundle_5.loadScene("Neko", function(err, scence) {
                  if (err) {
                    Windown_1.Windown.Dialog.showLog(TextDefine_1.TextDefine.Error);
                    Windown_1.Windown.UIManager.hideLoadingData();
                    return;
      ...
      MainView.prototype.onClickJoinTaiXiu = function() {
        return __awaiter(this, void 0, void 0, function() {
          var nodeProgress, listNode, per, funPro, pre, node, _i, nodeProgress_1, temp;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              Windown_1.Windown.UIManager.objGameWating[GAME_TYPE_1.default.TaiXiu] = true;
             ...
             case 1:
              ...
              per = 0;
              funPro = function(count, total) {
                for (var _i = 0, nodeProgress_2 = nodeProgress; _i < nodeProgress_2.length; _i++) {
                  var temp = nodeProgress_2[_i];
                  temp.setPercent(per);
                  count / total > per && (per = count / total);
                }
              };
              return [ 4, Windown_1.Windown.loadRes(GAME_TYPE_1.default.TaiXiu.toString(), "TaiXiu", cc.Prefab, funPro) ];
             ...
             case 2:
              ...
              node.parent = Windown_1.Windown.UIManager.parentMiniGame;
              Windown_1.Windown.UIManager.objGameWating[GAME_TYPE_1.default.TaiXiu] = false;
              for (_i = 0, nodeProgress_1 = nodeProgress; _i < nodeProgress_1.length; _i++) {
                temp = nodeProgress_1[_i];
                temp.node.destroy();
              }
              return [ 2 ];
    ...
    "../Bundle/Baccarat/Scripts/BaccaratController": void 0,
  ...
  NapTab: [ function(require, module, exports) {
    ...
    var NapTab = function(_super) {
      ...
      NapTab.prototype.onClickItemBtn = function(event, data) {
        ...
        cc.tween(this.lbMenhGia.node).set({
          opacity: 0,
          y: this.lbMenhGia.node.y + 50
        }).to(.2, {
          opacity: 255,
          y: this.lbMenhGia.node.y
        }, {
          easing: cc.easing.sineIn
        }).start();
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.refesh = function() {
        ...
        var _loop_1 = function(temp) {
          ...
          if (temp.isChecked) {
            var listdata = null;
            this_1.lbTime.node.active = true;
            if ("napngay" == name) listdata = Windown_1.Windown.NhiemVuConTroller.listQuestNapNgay; else if ("choigame" == name) listdata = Windown_1.Windown.NhiemVuConTroller.listQuestChoiGame; else if ("tanthu" == name) {
              ...
              this_1.lbTime.node.active = false;
            }
            listdata.forEach(function(data) {
              data.putUtfString("nameTab", name);
            });
            listdata && this_1.scr.init(listdata);
          }
          cc.log(name);
          if ("napngay" == name) {
  ...
  TabSuKien: [ function(require, module, exports) {
    ...
    var TabSuKien = function(_super) {
      ...
      TabSuKien.prototype.showInfo = function(obj) {
        ...
        this.scr.content.children.forEach(function(item) {
          cc.log("Child Name=" + item.name);
          item.getComponent(ItemSuKien_1.default).bg.spriteFrame = item.getComponent(ItemSuKien_1.default).spriteBg[0];
          item.getComponent(ItemSuKien_1.default).lbInfo.node.color = cc.Color.WHITE;
        });
      };
  ...
  TietKiem: [ function(require, module, exports) {
    ...
    var TietKiem = function(_super) {
      ...
      function TietKiem() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.spineDice1 = null;
        _this.spineDice2 = null;
        _this.spineDice3 = null;
        _this.spineBox = null;
      ...
      TietKiem.prototype.onDisable = function() {
        cc.systemEvent.targetOff(this);
        this.lbBaseTichLuy.node.active = this.lbBonus.node.active = this.lbTotal.node.active = false;
        this.spineDice1.node.active = this.spineDice2.node.active = this.spineDice3.node.active = false;
        this.spineBox.setAnimation(0, "normal", false);
      };
      TietKiem.prototype.show = function() {
        ...
        this.getComponent(cc.Animation).play("OpenTietKiem");
      };
      TietKiem.prototype.response = function(SFSObject) {
        cc.log("TietKiem:", Windown_1.Windown.SFSObjToJson(SFSObject));
        ...
        if (currnet >= max) {
          ...
          this.btnReceive.node.color = cc.Color.WHITE;
        } else {
          this.btnReceive.interactable = true;
          this.nodeIconPiggky.active = false;
          this.btnReceive.node.color = cc.Color.GRAY;
        }
        cc.log("nhay vao respinse ne");
      };
      TietKiem.prototype.setDiceResult = function(result, currnetUser, moneyTake) {
        var _this = this;
        this.spineDice1.node.active = this.spineDice2.node.active = this.spineDice3.node.active = true;
        this.spineBox.setAnimation(0, "ban", false);
        this.spineDice1.setAnimation(0, "1_" + result[0], false);
        this.spineDice2.setAnimation(0, "2_" + result[1], false);
        this.spineDice3.setAnimation(0, "3_" + result[2], false);
        this.sprDice1.play("randomSprite1");
        this.sprDice2.play("randomSprite2");
        this.sprDice3.play("randomSprite3");
        this.spineDice1.setCompleteListener(function() {
          _this.sprDice1.stop("randomSprite1");
          _this.sprDice1.getComponent(cc.Sprite).spriteFrame = _this.listSprDice[result[0] - 1];
        });
        this.spineDice2.setCompleteListener(function() {
          _this.sprDice2.stop("randomSprite2");
          _this.sprDice2.getComponent(cc.Sprite).spriteFrame = _this.listSprDice[result[1] - 1];
        });
        this.spineDice3.setCompleteListener(function() {
          _this.sprDice3.stop("randomSprite3");
          _this.sprDice3.getComponent(cc.Sprite).spriteFrame = _this.listSprDice[result[2] - 1];
          _this.setEffectResult(currnetUser, moneyTake);
        });
      };
      TietKiem.prototype.responseTake = function(SFSObject) {
        return __awaiter(this, void 0, void 0, function() {
          var moneyTake, currnetUser, moneyMax, agMiniWin, resultDice, audi0;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              cc.log("responseTake:", Windown_1.Windown.SFSObjToJson(SFSObject));
              Windown_1.Windown.Dialog.checkAndShowLog(SFSObject);
              moneyTake = SFSObject.getInt("mt");
              currnetUser = SFSObject.get("mcr");
              moneyMax = SFSObject.getInt("m");
              agMiniWin = SFSObject.get("agMiniWin");
              this.lbBaseTichLuy.string = Windown_1.Windown.formatNumber(moneyMax);
              this.lbBonus.string = Windown_1.Windown.formatNumber(agMiniWin);
              this.lbTotal.string = Windown_1.Windown.formatNumber(agMiniWin + moneyMax);
              this.cur = 0;
              this.max = moneyMax;
              this.spProgress.fillRange = 0;
              resultDice = JSON.parse(SFSObject.get("viewMini"));
              audi0 = Windown_1.Windown.AudioManager;
              audi0.playEffect(audi0.takeMoney);
              this.nodeIconPiggky.active = false;
              this.setDiceResult(resultDice, currnetUser, moneyTake);
              return [ 4, this.makeDelay(1) ];
      ...
      TietKiem.prototype.activeSpineLight = function(position) {
        this.spineLight.node.active = true;
        this.spineLight.setAnimation(0, "animation", false);
        this.spineLight.node.position = position;
      };
      TietKiem.prototype.setEffectResult = function(currnetUser, moneyTake) {
        return __awaiter(this, void 0, void 0, function() {
          var timeRun, acEffect, nodeEff;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              this.lbBaseTichLuy.node.active = true;
              timeRun = .5;
              acEffect = cc.tween().parallel(cc.tween().set({
                scale: 2.5,
                opacity: 0
              }).to(timeRun, {
                scale: .5,
              ...
              acEffect.clone(this.lbBaseTichLuy.node).start();
              return [ 4, Windown_1.Windown.makeDelay(timeRun) ];

             case 1:
              _a.sent();
              this.activeSpineLight(this.lbBaseTichLuy.node.position);
              this.lbBonus.node.active = true;
              acEffect.clone(this.lbBonus.node).start();
              return [ 4, Windown_1.Windown.makeDelay(timeRun) ];

             case 2:
              _a.sent();
              this.activeSpineLight(this.lbBonus.node.position);
              this.lbTotal.node.active = true;
              acEffect.clone(this.lbTotal.node).start();
              return [ 4, Windown_1.Windown.makeDelay(timeRun) ];

             case 3:
              _a.sent();
              this.activeSpineLight(this.lbTotal.node.position);
              return [ 4, Windown_1.Windown.makeDelay(.5) ];
             ...
             case 5:
              nodeEff = _a.sent();
              return [ 4, nodeEff.show(currnetUser, cc.v2(190, -290), moneyTake) ];
      ...
      __decorate([ property(sp.Skeleton) ], TietKiem.prototype, "spineDice1", void 0);
      __decorate([ property(sp.Skeleton) ], TietKiem.prototype, "spineDice2", void 0);
      __decorate([ property(sp.Skeleton) ], TietKiem.prototype, "spineDice3", void 0);
      __decorate([ property(sp.Skeleton) ], TietKiem.prototype, "spineBox", void 0);
      __decorate([ property(sp.Skeleton) ], TietKiem.prototype, "spineLight", void 0);
      __decorate([ property(cc.Animation) ], TietKiem.prototype, "sprDice1", void 0);
      __decorate([ property(cc.Animation) ], TietKiem.prototype, "sprDice2", void 0);
      __decorate([ property(cc.Animation) ], TietKiem.prototype, "sprDice3", void 0);
      ...
      __decorate([ property(cc.Label) ], TietKiem.prototype, "lbBaseTichLuy", void 0);
      __decorate([ property(cc.Label) ], TietKiem.prototype, "lbBonus", void 0);
      __decorate([ property(cc.Label) ], TietKiem.prototype, "lbTotal", void 0);
      __decorate([ property(cc.Sprite) ], TietKiem.prototype, "spProgress", void 0);
      __decorate([ property([ cc.SpriteFrame ]) ], TietKiem.prototype, "listSprDice", void 0);
      __decorate([ property(cc.Node) ], TietKiem.prototype, "nodeIconPiggky", void 0);
      __decorate([ property(cc.Button) ], TietKiem.prototype, "btnReceive", void 0);
  ...
  Windown: [ function(require, module, exports) {
    (function(Buffer) {
      ...
      var Windown = function() {
        ...
        Windown.Neko = null;
        Windown.KingKong = null;
        Windown.TaiXiu = null;
        Windown.BtnMiniGame = null;
        Windown.BotController = null;
        Windown.XengController = null;
        Windown.BaccaratController = null;
        Windown.BaccaratView = null;
