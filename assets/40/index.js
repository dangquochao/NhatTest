  ...
  KingKongSymbol: [ function(require, module, exports) {
    ...
    var SymbolKingKong = function(_super) {
      ...
      SymbolKingKong.prototype.showScatter = function() {
        ...
        cc.log("showScatter:isFreeSpin" + Windown_1.Windown.KingKong.isFreeSpin);
  ...
  KingKongView: [ function(require, module, exports) {
    ...
    var KingKongView = function(_super) {
      ...
      KingKongView.prototype.onClickSpin = function() {
        ...
        5 == this.indexSpinTest || 10 == this.indexSpinTest ? this.sendClickSpinTest("[[1,2,3],[12,3,4],[12,5,6],[12,7,8],[9,10,11]]") : this.sendClickSpin();
      };
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                   case 0:
                    ...
                    return [ 4, Windown_1.Windown.KingKong.getMakeDelay(this.isWin2Scatter ? 5 : 8).prosime ];
      ...
      KingKongView.prototype.setAutoSpin = function(numberSession, litmitValue) {
        ...
        cc.log("setAutoSpin---\x3elitmitValue:", litmitValue);
        cc.log("setAutoSpin---\x3elimitLoseValue:", this.limitLoseValue);
